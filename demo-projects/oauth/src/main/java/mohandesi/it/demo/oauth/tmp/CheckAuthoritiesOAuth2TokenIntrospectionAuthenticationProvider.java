...
//
// import mohandesi.it.demo.oauth.tmp.EndPointBasedGrantedAuthority;
//
// public class CheckAuthoritiesOAuth2TokenIntrospectionAuthenticationProvider implements
...
//            return new
// OAuth2TokenIntrospectionAuthenticationToken(tokenIntrospectionAuthentication.getToken(),
...
//
//            String realmAccessFromRequest = (String)
// additionalParametersFromRequest.get("realm-access");
//            String requestingResourceServerId =
// clientPrincipal.getRegisteredClient().getClientId();
//
////        Map<String,Set<String>>
//            for (GrantedAuthority ga : realmAccessFromClaims ) {
//                Set<String> grantedUrls = ((EndPointBasedGrantedAuthority)
// ga).getEndPointBasedAuthorities().get(requestingResourceServerId);
...
//            OAuth2Authorization.Token<OAuth2Token> authorizedToken, RegisteredClient
// authorizedClient) {
//
...
//            URL convertedValue = ClaimConversionService.getSharedInstance().convert(value,
// URL.class);
...
//            authorizationService = getOptionalBean(httpSecurity,
...
//    }
//
//    static OAuth2ClientAuthenticationToken
// getAuthenticatedClientElseThrowInvalidClient(Authentication authentication) {
//        OAuth2ClientAuthenticationToken clientPrincipal = null;
//        if
// (OAuth2ClientAuthenticationToken.class.isAssignableFrom(authentication.getPrincipal().getClass())) {
